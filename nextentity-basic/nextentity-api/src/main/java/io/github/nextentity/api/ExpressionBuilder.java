...
public interface ExpressionBuilder<T, U, B> {
    ...
    interface Conjunction<T> extends TypedExpression<T, Boolean> {
        ...
        Conjunction<T> andIf(boolean predicate, Query.PredicateBuilder<T> predicateBuilder);
    ...
    interface Disjunction<T> extends TypedExpression<T, Boolean> {
        ...
        Disjunction<T> orIf(boolean predicate, Query.PredicateBuilder<T> predicateBuilder);
