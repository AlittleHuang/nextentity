...
public interface Query {
    ...
    interface Where<T, U> extends OrderBy<T, U> {
        ...
        <N extends Number> NumberOperator<T, N, ? extends Where<T, U>> where(Path.NumberPath<T, N> path);

        StringOperator<T, ? extends Where<T, U>> where(Path.StringPath<T> path);
    ...
    interface Where0<T, U> extends GroupBy<T, U>, Where<T, U> {
        ...
        <N extends Number> NumberOperator<T, N, Where0<T, U>> where(Path.NumberPath<T, N> path);

        StringOperator<T, Where0<T, U>> where(Path.StringPath<T> path);
