...
@Slf4j
public class InternalExpressions {
    ...
    public static boolean isNullOrTrue(Expression expression) {
        return expression == null || expression == EMPTY || InternalExpressions.isTrue(expression);
    }
    ...
    public static Expression of(Object value) {
        ...
        return InternalExpressions.literal(value);
    }
    ...
    public static EntityPath column(String path) {
        return InternalExpressions.newColumn(new String[]{path});
    }

    public static EntityPath column(List<String> paths) {
        return InternalExpressions.newColumn(paths.toArray(EmptyArrays.STRING));
    }
    ...
    public static Expression operate(Expression l, Operator o, List<? extends Expression> r) {
        ...
        return InternalExpressions.newOperation(builder.build(), o);
    }
