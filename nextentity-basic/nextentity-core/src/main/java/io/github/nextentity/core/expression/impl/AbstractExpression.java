...
import io.github.nextentity.api.PredicateBuilder;
...
interface AbstractExpression extends NumberPathExpression, StringPathExpression, BooleanPathExpression, EntityPathExpression {
    ...
    @Override
    default ExpressionBuilder.Conjunction andIf(boolean predicate, PredicateBuilder predicateBuilder) {
    ...
    @Override
    default ExpressionBuilder.Disjunction orIf(boolean predicate, PredicateBuilder predicateBuilder) {
